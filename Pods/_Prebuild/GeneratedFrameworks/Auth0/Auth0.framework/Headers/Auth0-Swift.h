...
- (void)loginWithUsernameOrEmail:(NSString * _Nonnull)username password:(NSString * _Nonnull)password realm:(NSString * _Nonnull)realm audience:(NSString * _Nonnull)audience scope:(NSString * _Nonnull)scope parameters:(NSDictionary<NSString *, id> * _Nullable)parameters callback:(void (^ _Nonnull)(NSError * _Nullable, A0Credentials * _Nullable))callback;
...
- (void)renewWithRefreshToken:(NSString * _Nonnull)refreshToken scope:(NSString * _Nonnull)scope callback:(void (^ _Nonnull)(NSError * _Nullable, A0Credentials * _Nullable))callback;
